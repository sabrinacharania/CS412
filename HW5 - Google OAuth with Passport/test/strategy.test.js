...
describe('Strategy', function() {
  ...
  describe('authorization request with documented parameters', function() {
    ...
    before(function(done) {
      chai.passport.use(strategy)
        ...
        .authenticate({ prompt: 'select_account', loginHint: 'me@mail.com', accessType: 'offline' });
    });
  
    it('should be redirected', function() {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?access_type=offline&prompt=select_account&login_hint=me%40mail.com&response_type=code&client_id=46055328831-ti3v2lkfqiqut3vmck3pipcsfq4eij88.apps.googleusercontent.com');
    });
  ...
  describe('authorization request with documented parameters from OpenID Connect', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?display=touch&response_type=code&client_id=46055328831-ti3v2lkfqiqut3vmck3pipcsfq4eij88.apps.googleusercontent.com');
    });
  ...
  describe('authorization request with incremental authorization parameters', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?include_granted_scopes=true&response_type=code&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdrive.file&client_id=46055328831-ti3v2lkfqiqut3vmck3pipcsfq4eij88.apps.googleusercontent.com');
    });
  ...
  describe('authorization request with Google Apps for Work parameters', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?hd=mycollege.edu&response_type=code&client_id=46055328831-ti3v2lkfqiqut3vmck3pipcsfq4eij88.apps.googleusercontent.com');
    });
  ...
  describe('authorization request with Google+ parameters', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?request_visible_actions=http%3A%2F%2Fschema.org%2FAddAction%20http%3A%2F%2Fschema.org%2FReviewAction&response_type=code&client_id=46055328831-ti3v2lkfqiqut3vmck3pipcsfq4eij88.apps.googleusercontent.com');
    });
  ...
  describe('authorization request with OpenID 2.0 migration parameters', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?openid.realm=http%3A%2F%2Fwww.example.com%2F&response_type=code&client_id=46055328831-ti3v2lkfqiqut3vmck3pipcsfq4eij88.apps.googleusercontent.com');
    });
  ...
  describe('authorization request with undocumented parameters', function() {
    ...
    before(function(done) {
      chai.passport.use(strategy)
        ...
        .authenticate({ approvalPrompt: 'force', userID: 'user@gmail.com' });
    });
  
    it('should be redirected', function() {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?approval_prompt=force&user_id=user%40gmail.com&response_type=code&client_id=46055328831-ti3v2lkfqiqut3vmck3pipcsfq4eij88.apps.googleusercontent.com');
    });
